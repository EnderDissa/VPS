...
class ApiExceptionHandlerTest {
    ...
    void handleTypeMismatch() {
        DataIntegrityViolationException ex = new DataIntegrityViolationException("Required query parameter 'id' is missing");
        ...
        client.get().uri("/error")
                ...
                .expectBody()
                .jsonPath("$.code").isEqualTo("DATA_INTEGRITY_VIOLATION")
                .jsonPath("$.details[0]").isEqualTo("Required query parameter 'id' is missing");
    }
}
